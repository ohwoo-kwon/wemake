...
--> statement-breakpoint
ALTER TABLE "profiles" RENAME COLUMN "prfile_id" TO "profile_id";--> statement-breakpoint
ALTER TABLE "follows" DROP CONSTRAINT "follows_follower_id_profiles_prfile_id_fk";
--> statement-breakpoint
ALTER TABLE "follows" DROP CONSTRAINT "follows_following_id_profiles_prfile_id_fk";
--> statement-breakpoint
ALTER TABLE "profiles" DROP CONSTRAINT "profiles_prfile_id_users_id_fk";
--> statement-breakpoint
